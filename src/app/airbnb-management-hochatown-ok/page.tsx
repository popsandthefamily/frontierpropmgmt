...
const COMPARISON_ROWS: {
  ...
  },
  {
    label: "Headline fee",
    values: {
      boutique: "20% of net rental revenue",
      largeLocal: "20–30%",
      national: "25–40%",
...
const pageFAQ = [
  ...
  },
  {
    ...
    answer:
      "20% of net rental revenue, with no setup fee and no monthly minimum. The 20% is calculated after platform host fees and occupancy taxes come out, not on the headline booking total. Cleaning and pet fees pass through to cleaners and are not part of the 20%. Maintenance is itemized at cost.",
  },
  {
    ...
    <>
      ...
      <JsonLd
        ...
        data={{
          ...
          description:
            "Boutique, owner-operated Airbnb and short-term rental management for Hochatown cabin owners. Daily dynamic pricing, guest communication, cleaning coordination, maintenance, and reporting. 20% of net rental revenue, no monthly minimum.",
          provider: {
