...
export const managementFAQ: FAQItem[] = [
  {
    ...
    answer:
      "20% of net rental revenue. That is the entire recurring management fee. The 20% is calculated on what is left after platform host fees and occupancy taxes come out, not on the headline booking total; cleaning and pet fees pass through directly to cleaners and are not part of the calculation. There is no setup fee and no monthly minimum — if your cabin makes $0 in a month you owe us $0. Optional professional photography is $750 (only if you want our shoot). Everything else (utilities, consumables, linens, maintenance, pool / hot-tub service, permit renewals) is billed separately at cost with the receipt on your monthly statement. Maintenance items over $300 always require your approval first.",
  },
  {
